...
int getcmd(char *buf, int nbuf)
{
    ...
    write(2, "$ ", 2);
      ...
      16:	3ce58593          	addi	a1,a1,974 # 13e0 <malloc+0xee>
      1a:	4509                	li	a0,2
...
void panic(char *s)
{
    ...
    fprintf(2, "%s\n", s);
      ...
      64:	38858593          	addi	a1,a1,904 # 13e8 <malloc+0xf6>
      68:	4509                	li	a0,2
...
int fork1(void)
{
    ...
    return pid;
      ...
      9e:	35650513          	addi	a0,a0,854 # 13f0 <malloc+0xfe>
...
00000000000000aa <runcmd>:
{
    ...
    switch (cmd->type)
      ...
      ca:	43e70713          	addi	a4,a4,1086 # 1504 <malloc+0x212>
      ...
      e4:	31850513          	addi	a0,a0,792 # 13f8 <malloc+0x106>
     ...
     106:	2fe58593          	addi	a1,a1,766 # 1400 <malloc+0x10e>
     10a:	4509                	li	a0,2
    ...
    exit(0);
     ...
     152:	2c258593          	addi	a1,a1,706 # 1410 <malloc+0x11e>
     156:	4509                	li	a0,2
     ...
     1e8:	23c50513          	addi	a0,a0,572 # 1420 <malloc+0x12e>
...
execcmd(void)
{
    ...
    cmd = malloc(sizeof(*cmd));
     ...
     28a:	06c080e7          	jalr	108(ra) # 12f2 <malloc>
     28e:	84aa                	mv	s1,a0
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
    ...
    cmd = malloc(sizeof(*cmd));
     ...
     2d4:	022080e7          	jalr	34(ra) # 12f2 <malloc>
     2d8:	84aa                	mv	s1,a0
    memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
    ...
    cmd = malloc(sizeof(*cmd));
     ...
     32e:	fc8080e7          	jalr	-56(ra) # 12f2 <malloc>
     332:	84aa                	mv	s1,a0
    memset(cmd, 0, sizeof(*cmd));
     334:	4661                	li	a2,24
     336:	4581                	li	a1,0
...
listcmd(struct cmd *left, struct cmd *right)
{
    ...
    cmd = malloc(sizeof(*cmd));
     ...
     374:	f82080e7          	jalr	-126(ra) # 12f2 <malloc>
     378:	84aa                	mv	s1,a0
    memset(cmd, 0, sizeof(*cmd));
     37a:	4661                	li	a2,24
     37c:	4581                	li	a1,0
...
backcmd(struct cmd *subcmd)
{
    ...
    cmd = malloc(sizeof(*cmd));
     ...
     3b6:	f40080e7          	jalr	-192(ra) # 12f2 <malloc>
     3ba:	84aa                	mv	s1,a0
    memset(cmd, 0, sizeof(*cmd));
     3bc:	4641                	li	a2,16
     3be:	4581                	li	a1,0
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
    ...
    while (peek(ps, es, "<>"))
     ...
     5b0:	e9cb8b93          	addi	s7,s7,-356 # 1448 <malloc+0x156>
    {
    ...
    while (peek(ps, es, "<>"))
     ...
     5c2:	e6a50513          	addi	a0,a0,-406 # 1428 <malloc+0x136>
...
parseexec(char **ps, char *es)
{
    ...
    if (peek(ps, es, "("))
     ...
     6aa:	daa60613          	addi	a2,a2,-598 # 1450 <malloc+0x15e>
    ...
    while (!peek(ps, es, "|)&;"))
     ...
     6da:	d9ab0b13          	addi	s6,s6,-614 # 1470 <malloc+0x17e>
    {
    ...
    return ret;
     ...
     714:	d4850513          	addi	a0,a0,-696 # 1458 <malloc+0x166>
    ...
    while (!peek(ps, es, "|)&;"))
     ...
     776:	cee50513          	addi	a0,a0,-786 # 1460 <malloc+0x16e>
...
0000000000000790 <parsepipe>:
{
    ...
    if (peek(ps, es, "|"))
     ...
     7b0:	ccc60613          	addi	a2,a2,-820 # 1478 <malloc+0x186>
     7b4:	85ce                	mv	a1,s3
     7b6:	854a                	mv	a0,s2
...
00000000000007fe <parseline>:
{
    ...
    while (peek(ps, es, "&"))
     ...
     820:	c64a0a13          	addi	s4,s4,-924 # 1480 <malloc+0x18e>
    ...
    if (peek(ps, es, ";"))
     ...
     856:	c3660613          	addi	a2,a2,-970 # 1488 <malloc+0x196>
     85a:	85ce                	mv	a1,s3
     85c:	854a                	mv	a0,s2
...
00000000000008a6 <parseblock>:
{
    ...
    if (!peek(ps, es, "("))
     ...
     8bc:	b9860613          	addi	a2,a2,-1128 # 1450 <malloc+0x15e>
    ...
    if (!peek(ps, es, ")"))
     ...
     8ec:	bb860613          	addi	a2,a2,-1096 # 14a0 <malloc+0x1ae>
     8f0:	85ca                	mv	a1,s2
     8f2:	8526                	mv	a0,s1
    ...
    cmd = parseredirs(cmd, ps, es);
     ...
     92e:	b6650513          	addi	a0,a0,-1178 # 1490 <malloc+0x19e>
     932:	fffff097          	auipc	ra,0xfffff
     936:	724080e7          	jalr	1828(ra) # 56 <panic>
        panic("syntax - missing )");
     93a:	00001517          	auipc	a0,0x1
     93e:	b6e50513          	addi	a0,a0,-1170 # 14a8 <malloc+0x1b6>
...
nulterminate(struct cmd *cmd)
{
    ...
    switch (cmd->type)
     ...
     96a:	bb670713          	addi	a4,a4,-1098 # 151c <malloc+0x22a>
...
00000000000009e2 <parsecmd>:
{
    ...
    peek(&s, es, "");
     ...
     a16:	aae60613          	addi	a2,a2,-1362 # 14c0 <malloc+0x1ce>
     a1a:	85a6                	mv	a1,s1
    ...
    nulterminate(cmd);
     ...
     a4c:	a8058593          	addi	a1,a1,-1408 # 14c8 <malloc+0x1d6>
     a50:	4509                	li	a0,2
     a52:	00000097          	auipc	ra,0x0
     a56:	7ba080e7          	jalr	1978(ra) # 120c <fprintf>
        panic("syntax");
     a5a:	00001517          	auipc	a0,0x1
     a5e:	9fe50513          	addi	a0,a0,-1538 # 1458 <malloc+0x166>
...
0000000000000a6a <parse_buffer>:
{
    ...
    if (buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' ')
     ...
     af8:	9e458593          	addi	a1,a1,-1564 # 14d8 <malloc+0x1e6>
     afc:	4509                	li	a0,2
     afe:	00000097          	auipc	ra,0x0
     b02:	70e080e7          	jalr	1806(ra) # 120c <fprintf>
...
0000000000000b3c <main>:
{
    ...
    while ((fd = open("console", O_RDWR)) >= 0)
     ...
     b52:	99a48493          	addi	s1,s1,-1638 # 14e8 <malloc+0x1f6>
     b56:	4589                	li	a1,2
     b58:	8526                	mv	a0,s1
    ...
    if (argc == 2)
     ...
     be6:	90e50513          	addi	a0,a0,-1778 # 14f0 <malloc+0x1fe>
     bea:	00000097          	auipc	ra,0x0
     bee:	650080e7          	jalr	1616(ra) # 123a <printf>
            exit(1);
     bf2:	4505                	li	a0,1
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     f76:	f56080e7          	jalr	-170(ra) # ec8 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
     ...
     f94:	0805c963          	bltz	a1,1026 <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     fa8:	5f450513          	addi	a0,a0,1524 # 1598 <digits>
     fac:	883a                	mv	a6,a4
  ...
  if(neg)
     fd0:	00088c63          	beqz	a7,fe8 <printint+0x66>
    buf[i++] = '-';
     fd4:	fd070793          	addi	a5,a4,-48
     fd8:	00878733          	add	a4,a5,s0
     fdc:	02d00793          	li	a5,45
     fe0:	fef70823          	sb	a5,-16(a4)
     fe4:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
     fe8:	02e05863          	blez	a4,1018 <printint+0x96>
    ...
    100e:	f56080e7          	jalr	-170(ra) # f60 <putc>
  while(--i >= 0)
    1012:	197d                	addi	s2,s2,-1
    1014:	ff3918e3          	bne	s2,s3,1004 <printint+0x82>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    1062:	4c55                	li	s8,21
    1064:	00000c97          	auipc	s9,0x0
    1068:	4dcc8c93          	addi	s9,s9,1244 # 1540 <malloc+0x24e>
        ...
        if(s == 0)
          s = "(null)";
        while(*s != 0){
    106c:	02800d93          	li	s11,40
  putc(fd, 'x');
    1070:	4d41                	li	s10,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    1072:	00000b97          	auipc	s7,0x0
    1076:	526b8b93          	addi	s7,s7,1318 # 1598 <digits>
    107a:	a839                	j	1098 <vprintf+0x6a>
        putc(fd, c);
    107c:	85ca                	mv	a1,s2
    107e:	8556                	mv	a0,s5
    1080:	00000097          	auipc	ra,0x0
    1084:	ee0080e7          	jalr	-288(ra) # f60 <putc>
    1088:	a019                	j	108e <vprintf+0x60>
    } else if(state == '%'){
    108a:	01498d63          	beq	s3,s4,10a4 <vprintf+0x76>
  for(i = 0; fmt[i]; i++){
    108e:	0485                	addi	s1,s1,1
    1090:	fff4c903          	lbu	s2,-1(s1)
    1094:	14090d63          	beqz	s2,11ee <vprintf+0x1c0>
    if(state == 0){
    1098:	fe0999e3          	bnez	s3,108a <vprintf+0x5c>
      if(c == '%'){
    109c:	ff4910e3          	bne	s2,s4,107c <vprintf+0x4e>
        state = '%';
    10a0:	89d2                	mv	s3,s4
    10a2:	b7f5                	j	108e <vprintf+0x60>
      if(c == 'd'){
    10a4:	11490c63          	beq	s2,s4,11bc <vprintf+0x18e>
    10a8:	f9d9079b          	addiw	a5,s2,-99
    10ac:	0ff7f793          	zext.b	a5,a5
    10b0:	10fc6e63          	bltu	s8,a5,11cc <vprintf+0x19e>
    10b4:	f9d9079b          	addiw	a5,s2,-99
    10b8:	0ff7f713          	zext.b	a4,a5
    10bc:	10ec6863          	bltu	s8,a4,11cc <vprintf+0x19e>
    10c0:	00271793          	slli	a5,a4,0x2
    10c4:	97e6                	add	a5,a5,s9
    10c6:	439c                	lw	a5,0(a5)
    10c8:	97e6                	add	a5,a5,s9
    10ca:	8782                	jr	a5
    ...
    10de:	ea8080e7          	jalr	-344(ra) # f82 <printint>
    10e2:	8b4a                	mv	s6,s2
      } else {
    ...
    10fa:	e8c080e7          	jalr	-372(ra) # f82 <printint>
    10fe:	8b4a                	mv	s6,s2
      state = 0;
    1100:	4981                	li	s3,0
    ...
    1116:	e70080e7          	jalr	-400(ra) # f82 <printint>
    111a:	8b4a                	mv	s6,s2
      state = 0;
    111c:	4981                	li	s3,0
    111e:	bf85                	j	108e <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    1120:	008b0793          	addi	a5,s6,8
    1124:	f8f43423          	sd	a5,-120(s0)
    1128:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    112c:	03000593          	li	a1,48
    1130:	8556                	mv	a0,s5
    1132:	00000097          	auipc	ra,0x0
    1136:	e2e080e7          	jalr	-466(ra) # f60 <putc>
  putc(fd, 'x');
    113a:	07800593          	li	a1,120
    113e:	8556                	mv	a0,s5
    1140:	00000097          	auipc	ra,0x0
    1144:	e20080e7          	jalr	-480(ra) # f60 <putc>
    1148:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    ...
    115a:	e0a080e7          	jalr	-502(ra) # f60 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    115e:	0992                	slli	s3,s3,0x4
    1160:	397d                	addiw	s2,s2,-1
    1162:	fe0914e3          	bnez	s2,114a <vprintf+0x11c>
        printptr(fd, va_arg(ap, uint64));
    1166:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    116a:	4981                	li	s3,0
    116c:	b70d                	j	108e <vprintf+0x60>
        s = va_arg(ap, char*);
    116e:	008b0913          	addi	s2,s6,8
    1172:	000b3983          	ld	s3,0(s6)
        if(s == 0)
    1176:	02098163          	beqz	s3,1198 <vprintf+0x16a>
        while(*s != 0){
    117a:	0009c583          	lbu	a1,0(s3)
    117e:	c5ad                	beqz	a1,11e8 <vprintf+0x1ba>
          putc(fd, *s);
    1180:	8556                	mv	a0,s5
    1182:	00000097          	auipc	ra,0x0
    1186:	dde080e7          	jalr	-546(ra) # f60 <putc>
          s++;
    118a:	0985                	addi	s3,s3,1
        while(*s != 0){
    118c:	0009c583          	lbu	a1,0(s3)
    1190:	f9e5                	bnez	a1,1180 <vprintf+0x152>
        s = va_arg(ap, char*);
    1192:	8b4a                	mv	s6,s2
      state = 0;
    1194:	4981                	li	s3,0
    1196:	bde5                	j	108e <vprintf+0x60>
          s = "(null)";
    1198:	00000997          	auipc	s3,0x0
    119c:	3a098993          	addi	s3,s3,928 # 1538 <malloc+0x246>
        while(*s != 0){
    11a0:	85ee                	mv	a1,s11
    11a2:	bff9                	j	1180 <vprintf+0x152>
        putc(fd, va_arg(ap, uint));
    11a4:	008b0913          	addi	s2,s6,8
    11a8:	000b4583          	lbu	a1,0(s6)
    11ac:	8556                	mv	a0,s5
    11ae:	00000097          	auipc	ra,0x0
    11b2:	db2080e7          	jalr	-590(ra) # f60 <putc>
    11b6:	8b4a                	mv	s6,s2
      state = 0;
    11b8:	4981                	li	s3,0
    11ba:	bdd1                	j	108e <vprintf+0x60>
        putc(fd, c);
    11bc:	85d2                	mv	a1,s4
    11be:	8556                	mv	a0,s5
    11c0:	00000097          	auipc	ra,0x0
    11c4:	da0080e7          	jalr	-608(ra) # f60 <putc>
      state = 0;
    11c8:	4981                	li	s3,0
    11ca:	b5d1                	j	108e <vprintf+0x60>
        putc(fd, '%');
    11cc:	85d2                	mv	a1,s4
    11ce:	8556                	mv	a0,s5
    11d0:	00000097          	auipc	ra,0x0
    11d4:	d90080e7          	jalr	-624(ra) # f60 <putc>
        putc(fd, c);
    11d8:	85ca                	mv	a1,s2
    11da:	8556                	mv	a0,s5
    11dc:	00000097          	auipc	ra,0x0
    11e0:	d84080e7          	jalr	-636(ra) # f60 <putc>
      state = 0;
    11e4:	4981                	li	s3,0
...
free(void *ap)
{
  ...
  if(p + p->s.size == bp){
    ...
    129e:	a091                	j	12e2 <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    12a0:	6398                	ld	a4,0(a5)
    12a2:	00e7e463          	bltu	a5,a4,12aa <free+0x3a>
    12a6:	00e6ea63          	bltu	a3,a4,12ba <free+0x4a>
{
    12aa:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    12ac:	fed7fae3          	bgeu	a5,a3,12a0 <free+0x30>
    12b0:	6398                	ld	a4,0(a5)
    12b2:	00e6e463          	bltu	a3,a4,12ba <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    12b6:	fee7eae3          	bltu	a5,a4,12aa <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    ...
    12ca:	fae60de3          	beq	a2,a4,1284 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
  ...
  if(p + p->s.size == bp){
    ...
    12de:	fae68ae3          	beq	a3,a4,1292 <free+0x22>
    p->s.ptr = bp->s.ptr;
...
malloc(uint nbytes)
{
  ...
  if(p == (char*)-1)
    ...
    134e:	d4e78793          	addi	a5,a5,-690 # 2098 <base>
    ...
    1376:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    137a:	00001717          	auipc	a4,0x1
    137e:	c8a73b23          	sd	a0,-874(a4) # 2010 <freep>
      return (void*)(p + 1);
  ...
  free((void*)(hp + 1));
    ...
    13aa:	eca080e7          	jalr	-310(ra) # 1270 <free>
  return freep;
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    13cc:	b68080e7          	jalr	-1176(ra) # f30 <sbrk>
  if(p == (char*)-1)
